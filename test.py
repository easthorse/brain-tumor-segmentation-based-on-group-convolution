...
parser.add_argument('-cfg', '--cfg', default= 'unet', required=False, type=str,
                    help='Your detailed configuration of the network')

parser.add_argument('-mode', '--mode', default=0, required=False, type=int, choices=[0, 1, 2],
...
parser.add_argument('-use_TTA', '--use_TTA', default=True, type=str2bool,
...
parser.add_argument('-save_format', '--save_format', default='npy', choices=['nii', 'npy'], type=str,
...
parser.add_argument('-restore', '--restore', default='model_epoch_210.pth', type=str,
                    help='The path to restore the model.')  # 'model_epoch_300.pth'
...
def main():
    ...
    # pdb.set_trace()
    # todo
    # valid_sampler = CycleSampler(len(valid_set), 0)
