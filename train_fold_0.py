...
parser.add_argument('-cfg', '--cfg', default='MFNet_GDL_all_semix_5split', required=False, type=str,
...
parser.add_argument('-batch_size', '--batch_size', default=12, type=int, help='Batch size')
parser.add_argument('-restore', '--restore', default='model_las.pth', type=str)# model_last.pth
...
def main():
    ...
    for i, data in enumerate(train_loader, args.start_iter):
        ...
        # validation
        # todo if (i+1) % int(enum_batches * args.save_freq) == 0 \
